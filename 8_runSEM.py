# %% [markdown]
# # 试试SEM 
# 根据之前大概的流程   从 气候背景（温度降水） 到 多样性 结构复杂度  再到  土壤水分 蒸腾 LST的变化  最后再到抵抗力  可以也加上干旱指数
# 用每个时间的  然后根据几个重要的变量  按照分位数排除极端值
...
# %%
df_all.to_csv(r'E:/python_output/fsc_drought/df_all_kndvi_sem_20260108.csv', index = False)
...
# %% [markdown]
# ### 2.1 先用分位数排除一下极端值
# 主要是  kndvi  sm_change  et_change  lst_change
...
# %%
df_use.to_csv(r'E:/python_output/fsc_drought/df_use.csv', index = False)
...
# %%
df_use_log.to_csv(r'E:/python_output/fsc_drought/df_use_log.csv', index = False)

# %% [markdown]
# ### 2.3 先用 正负值来建模
# 
# 使用正负值的时候  用 et_change2 和 lst_zs
...
# %%
ins_raw.to_csv(r'E:/python_output/fsc_drought/ins_raw_tempoffset_20251216.csv')
...
# %%
ins_raw_kndvi2.to_csv(r'E:/python_output/fsc_drought/ins_raw_kndvi2_tempoffset_20260105.csv')
...
# %%
ins_raw_kndvi2_log.to_csv(r'E:/python_output/fsc_drought/ins_raw_kndvi2_log_tempoffset_20260105.csv')
...
# %%
## 蒸腾
with xr.open_dataset(r'E:/python_output/fsc_drought/et_nt_change_kndvi_after2000.nc') as data:
    et_nt_change_kndvi_after2000 = data['et_change']
with xr.open_dataset(r'E:/python_output/fsc_drought/et_sh_change_kndvi_after2000.nc') as data:
...
# %%
## LST
with xr.open_dataset(r'E:/python_output/fsc_drought/lst_nt_change_kndvi_after2000.nc') as data:
    lst_nt_change_kndvi_after2000 = data['lst_change']
with xr.open_dataset(r'E:/python_output/fsc_drought/lst_sh_change_kndvi_after2000.nc') as data:
...
# %%
df_all_after2000.to_csv(r'E:/python_output/fsc_drought/df_all_kndvi_sem_after2000_20260105.csv', index = False)
...
# %%
ins_raw_after2000.to_csv(r'E:/python_output/fsc_drought/ins_raw_tempoffset_after2000_20260105.csv')
...
# %%
ins_raw_kndvi2_after2000.to_csv(r'E:/python_output/fsc_drought/ins_raw_kndvi2_tempoffset_after2000_20260105.csv')
...
# %%
ins_raw_kndvi2_log_after2000.to_csv(r'E:/python_output/fsc_drought/ins_raw_kndvi2_log_tempoffset_after2000_20260105.csv')
...
# %%
df_all_sif.to_csv(r'E:/python_output/fsc_drought/df_all_sif_20260105.csv', index = False)
...
# %%
df_use_sif.to_csv(r'E:/python_output/fsc_drought/df_use_sif.csv', index = False)
...
# %%
df_use_sif_log.to_csv(r'E:/python_output/fsc_drought/df_use_sif_log.csv', index = False)
...
# %%
ins_raw_sif.to_csv(r'E:/python_output/fsc_drought/ins_raw_tempoffset_sif_20260108.csv')
...
# %%
ins_raw_sif2.to_csv(r'E:/python_output/fsc_drought/ins_raw_tempoffset_sif2_20260108.csv')
...
# %%
ins_raw_sif2_log.to_csv(r'E:/python_output/fsc_drought/ins_raw_tempoffset_sif2_log_20260108.csv')
...
# %% [markdown]
# ## change log
# 1. 2025.12.16 重新跑了所有的模型
# 2. 2026.01.08 用Ydrou/Ymean 重新跑了所有的模型
# 

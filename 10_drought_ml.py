...
# %%
df_all_kndvi.to_csv(r'./python_output/fsc_drought/df_ml_all_kndvi.csv', index = False)
...
# %%
df_all_kndvi_after2000.to_csv(r'./python_output/fsc_drought/df_ml_all_kndvi_after2000_20251216.csv', index = False)
...
# %%
df_all_kndvi2.to_csv(r'./python_output/fsc_drought/df_ml_all_kndvi2_20251216.csv', index = False)
...
# %%
df_all_kndvi2_after2000.to_csv(r'./python_output/fsc_drought/df_ml_all_kndvi2_after2000_20251216.csv', index = False)
...
# %%
df_all_sif.to_csv(r'./python_output/fsc_drought/df_ml_all_sif_20251213.csv', index = False)
...
# %%
df_all_sif2.to_csv(r'./python_output/fsc_drought/df_ml_all_sif2_20251213.csv', index = False)
...
# %%
drought_resistance_kndvi = pd.read_csv(r'./python_output/fsc_drought/df_ml_all_kndvi_20251216.csv')
...
# %%
drought_resistance_kndvi_after2000 = pd.read_csv(r'./python_output/fsc_drought/df_ml_all_kndvi_after2000_20251216.csv')
...
finalmodel_resistance_sif = xgb.XGBRegressor(**best_params_sif,early_stopping_rounds=30)  
...
drought_resistance_kndvi2 = pd.read_csv(r'./python_output/fsc_drought/df_ml_all_kndvi2_20251216.csv')
...
drought_resistance_kndvi2_after2000 = pd.read_csv(r'./python_output/fsc_drought/df_ml_all_kndvi2_after2000.csv')
...
loess_result_after2000 = sm.nonparametric.lowess(shap_explainer_resistance_kndvi2_after2000[:, 'fsc'].values, shap_explainer_resistance_kndvi2_after2000[:, 'fsc'].data, frac=0.3)  
...
drought_resistance_sif2 = pd.read_csv(r'./python_output/fsc_drought/df_ml_all_sif2_20251213.csv')
...
finalmodel_resistance_sif2 = xgb.XGBRegressor(**best_params_sif2,early_stopping_rounds=30)  
...
finalmodel_resistance_sif2_log = xgb.XGBRegressor(**best_params_sif2_log,early_stopping_rounds=30)  
...
def pdp_shap(ax, shap_data,model,X,shap_col, pi_col, yrang_f = [0.25,0.25], MLocator = 0.01):
    ...
    loess_result = sm.nonparametric.lowess(shap_data[:, 'fsc'].values, shap_data[:, 'fsc'].data, frac=0.3) 
    x_loess, y_loess = loess_result[:, 0], loess_result[:, 1]
